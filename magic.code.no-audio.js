...
const MODELS = {
  ...
  GEMINI_2_5_FLASH_LITE: 'gemini-2.5-flash-8b',
...
Числа: всі числові значення повинні бути записані ВИКЛЮЧНО цифрами.
Позивні: всі ВІДОМІ позивні в тексті повинні бути записані ВЕЛИКИМИ ЛІТЕРАМИ.
...
function setupAutoClickListener() {
    ...
    const attachListeners = () => {
        document.querySelectorAll(SELECTORS.transcribeBtn).forEach((btn) => {
            if (btn.dataset.autoClickAttached) return;
